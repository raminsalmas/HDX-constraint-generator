...
# Open and read the model RFU data of all runs, output from the modeller.
...
# Open and read the information in the kint file.
K_int = []
...
# Open and read the input data submitted to the modeller as an input file.
...
# Initialize lists to store data from RFU_exp, RFU_EXP, and other variables.
